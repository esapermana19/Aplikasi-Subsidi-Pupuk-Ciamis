    ...
    <div class="flex flex-col gap-3 mb-4">
        ...
        <div class="flex justify-between mt-1">
            <div class="w-1/2 pr-2">
                ...
                <h3 class="text-[11px] font-bold text-gray-900 leading-tight">{{ Auth::user()->mitra->nama_mitra ?? '-' }}</h3>
                <p class="text-[9px] text-gray-500 mt-0.5">No: {{ Auth::user()->mitra->nomor_mitra ?? '-' }}</p>
                <p class="text-[9px] text-gray-500 mt-0.5 leading-tight">{{ Auth::user()->mitra->alamat ?? '-' }}</p>
            </div>
            <div class="w-1/2 pl-2 text-right">
