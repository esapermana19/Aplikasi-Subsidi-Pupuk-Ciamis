                ...
                <form action="{{ route('login.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="email" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition text-sm" placeholder="Masukkan Email Anda">
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password" class="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition text-sm" placeholder="********">
